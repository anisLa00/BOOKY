...
from .schemas import CreateReviewModel,ReviewModel
...
class ReviewService:
    async def create_review_book(
        ...
        try:
            ...
            review_data_dist=review_data.model_dump()
            new_review=Review(**review_data_dist )
